...
- Techinal Security Team - Weekley Report Creation and publicatin and notification bot 
...
___This will reduce the risk that the script can wipe out the original template due an error__
